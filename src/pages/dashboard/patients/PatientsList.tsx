          ...
          <Button asChild variant="outline" className="flex-1 lg:flex-none">
            ...
            <Button
              ...
              try {
                ...
                const reportData = patients.length > 0 ? patients[0] : null;

                const exampleReport = `
            MEDICAL REPORT
            Date: ${new Date().toLocaleDateString()}
            Doctor: AI-Powered LLM
            Patient: ${reportData ? reportData.name : "John Doe"}
            Age: ${reportData ? reportData.age : "45"} | Gender: ${
                reportData ? reportData.gender : "Male"
                }
            ---
            *Clinical Findings:*
            - Heart Rate: ${reportData ? "120 bpm (Tachycardia)" : "N/A"}
            - Oxygen Saturation: ${reportData ? "89% (Hypoxemia)" : "N/A"}
            - Temperature: ${reportData ? "39.2°C (Febrile)" : "N/A"}
            - Blood Pressure: ${
                reportData
                  ? "SBP 85 mmHg, MAP 65 mmHg (Hypotension)"
                  : "N/A"
                }
            - Lactate Level: ${
                reportData
                  ? "4.2 mmol/L (Elevated, Suggests Hypoperfusion)"
                  : "N/A"
                }
            ---
            *Conclusion:*
            The patient exhibits signs of ${
                reportData ? "sepsis" : "a dummy condition"
                }, including ${
                reportData
                  ? "hemodynamic instability and metabolic acidosis"
                  : "placeholder symptoms"
                }.
            Immediate treatment recommended: ${
                reportData
                  ? "IV fluids, broad-spectrum antibiotics, and monitoring"
                  : "dummy treatment"
                }.
            `;
                ...
                doc.setFontSize(16);
                doc.setTextColor(33, 37, 41);
                doc.text("This is an AI-generated report", 20, 20);
                ...
                doc.text(exampleReport, marginX, marginY, {
                maxWidth: textWidth,
                });

                const fileName = `Medical_Report_${
                reportData ? reportData.name : "Dummy"

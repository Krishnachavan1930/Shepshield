...
import { Activity, Users, FileUp, AlertCircle, Lightbulb, ArrowUp, ArrowDown } from 'lucide-react';
                ...
                {recentPatients.map((patient) => (
                  <div key={patient.id} className="flex items-center justify-between border-b pb-3">
                    ...
                    <div className="text-sm">
                      <p className={`font-medium ${getRiskTextColor(patient.riskLevel)}`}>
              ...
              <div className="space-y-2">
                {schedule.slice(0, 3).map((item, i) => (
                  <div key={i} className="flex justify-between items-center border-b pb-2">
                    ...
                    <div className={`text-xs px-2 py-1 rounded-full ${item.type === 'meeting' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'}`}>
                      {item.type}
                    </div>
                  </div>
                ))}
          ...
          <Card className="hover-scale">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Button variant="outline" size="sm" className="w-full mt-2">System Details</Button>
              </div>
            </CardContent>
          </Card>
        </AnimatedSection>
...
const recentPatients = [
  { id: 'P-1234', name: 'Emily Johnson', riskLevel: 'High', lastUpdated: '10 mins ago' },
  { id: 'P-2345', name: 'Robert Smith', riskLevel: 'Medium', lastUpdated: '25 mins ago' },
  { id: 'P-3456', name: 'Maria Garcia', riskLevel: 'Low', lastUpdated: '1 hour ago' },
  { id: 'P-4567', name: 'James Wilson', riskLevel: 'High', lastUpdated: '2 hours ago' },
  { id: 'P-5678', name: 'Linda Chen', riskLevel: 'Medium', lastUpdated: '3 hours ago' },
];

const departments = [
  { name: 'Emergency', cases: 42, percentage: 75, trend: 'up', change: 12 },
  { name: 'ICU', cases: 28, percentage: 50, trend: 'up', change: 8 },
  { name: 'General Medicine', cases: 18, percentage: 32, trend: 'down', change: 5 },
...
const schedule = [
  ...
  { title: 'Research Discussion', time: '02:30 PM - 03:30 PM', type: 'meeting' },
